...
})({"chpOG":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 61669;
...
let initialeState = {
    products: (0, _dataJs.productsList),
    cart: []
};
function reducer(state = initialeState, action) {
    switch(action.type){
        ...
        case REM_ITEM:
            return {
                ...state,
                cart: state.cart.filter((x)=>x.productId !== action.payload.productId)
            };
        case ADD_QUANTITY:
            return {
                ...state,
...
},{"./data.js":"fFIED","redux":"7RvxM"}],"fFIED":[function(require,module,exports,__globalThis) {
...
},{}],"7RvxM":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cjBsI"}]},["chpOG","4ZGjQ"], "4ZGjQ", "parcelRequire0aed", {})

//# sourceMappingURL=Handle Complex State.f72d0d54.js.map
